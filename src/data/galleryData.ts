export interface GalleryItem {
  id: string;
  title: string;
  category: 'Showroom' | 'Office Supply' | 'Paper Stock' | 'Luxury Pens' | 'Art & Notebooks';
  image: string;
  description: string;
}
...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    description: 'Our spacious multi-floor showroom displaying over 7,000+ college, corporate, and office stationery items.'
  },
  {
    id: 'gal-2',
  ...
  {
    id: 'gal-4',
    title: 'Art & Craft Activity Material Display',
    category: 'Art & Notebooks',
    image: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?q=80&w=1200&auto=format&fit=crop',
    description: 'Comprehensive section dedicated to paints, chart papers, geometry kits, and creative materials.'
  },
  {
    id: 'gal-5',
